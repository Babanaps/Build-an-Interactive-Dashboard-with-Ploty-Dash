...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        # Calculate the total number of successful launches for each site
...
def update_scatter_chart(entered_site, selected_payload_range):
    ...
    # If ALL sites are selected, plot the scatter chart for all sites
    if entered_site == 'ALL':
        ...
        # Plot the scatter chart for the selected site
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',
                         color='Booster Version Category',
